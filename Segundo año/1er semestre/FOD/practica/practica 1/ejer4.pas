...
var
	opcion:string;
begin
	writeln('Elija a: para crear un archivo de empleados, b: para abir un archivo creado, c para agregar empleado, d: modificar edad de empleado, e: para exportar archivo o f: para exportar datos validos');
	readln(opcion);
